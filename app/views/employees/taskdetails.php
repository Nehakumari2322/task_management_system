...
<?php } ?>
<div class="container">
<form action="<?php echo URLROOT ;?>employees/updatetask" method="post" >
...
<div id="id01" class="modal">
        <form class="modal-content animate" action="<?php echo URLROOT; ?>employees/insertsubtaskdetails" method="post">
        ...
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="text" placeholder="Enter Assigned By" id="assigned_by" name="assigned_by" value="<?php echo $_SESSION['userid'];?>" readonly>
                </div>
                <div class="col">
